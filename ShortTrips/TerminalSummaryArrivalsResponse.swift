...
struct TerminalSummaryArrivalsResponse: Mappable {
  ...
  init(terminalSummaryArrivalsListResponse: TerminalSummaryArrivalsListResponse) {
    self.terminalSummaryArrivalsListResponse = terminalSummaryArrivalsListResponse
  }
